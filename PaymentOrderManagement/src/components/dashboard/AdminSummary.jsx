...
import { FaFileAlt, FaCheckCircle, FaHourglassHalf, FaTimesCircle, FaBuilding, FaUsers } from 'react-icons/fa'
    ...
    <div className='p-6'>
        <h3 className='text-2xl font-bold'>Dashboard Overview</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <SummaryCard icon={<FaUsers />} text="Total Employees" number={12} color="bg-teal-600" />
                ...
                <div className="mt-12">
                <h4 className="text-center text-xl font-bold">Leave Details</h4>
